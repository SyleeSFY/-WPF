...
{
    public class EducationalDepartament : Course_work.User
    {
        ...
        public EducationalDepartament(string firstName, string lastName, string middleName,
        ...
        public override void Add()
        {
            using (SQLiteConnection connection = new SQLiteConnection(connect))
            {
                ...
                string sql = @"INSERT INTO Staff 
                     (FirstName, LastName, MiddleName, Login, Password, Role) 
                     VALUES 
                     (@FirstName, @LastName, @MiddleName, @Login, @Password, @Role)";
